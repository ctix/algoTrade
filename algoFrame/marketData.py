...
class MarketDataSource:
    ...
    def start_market_simulation(self):
        if self.source == "yahoo":
            ...
            fullname = "..//tests//datum//" + self.ticker + ".day"
            pddata = daysDataOfStock(fullname)
            data = pddata.DF[self.start:self.end]
            self.data =data
        print data[:40]
        # print type(data)
...
if __name__ == '__main__':
    ...
    backtester = Backtester("sz002594", dt.datetime(2014, 1, 1), dt.datetime(2014, 12, 31),"tdx")
