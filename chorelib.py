...
def getStockData(stockCode):
    """ At the Market Trading time use urllib to open and get real time stock
    bidding and pricing ,delay exist ,always keep alarm to it
    ...
    #  TODO: Only need to use
    # 'stockcode' 'open', 'close','price','high', 'low','buy1','buy2','vol', 'amount',
    # so return 1,2,3,4,5,8,9 and the last datetime [hqList[30] + " " + atTime]
    return valList
